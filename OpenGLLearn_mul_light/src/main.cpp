...
int main() 
{
    ...
    Shader lightShader("glsl/LightVertexShader.vert", "glsl/LightFragmentShader.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (unsigned int i = 0; i < 4; i++) 
        {
            ...
            ourShader.setVec3("pointLight[" + std::to_string(i) + "].ambient", 0.15f*pointLightColor[i]);
            ourShader.setVec3("pointLight[" + std::to_string(i) + "].diffuse", 0.8f*pointLightColor[i]);
            ourShader.setVec3("pointLight[" + std::to_string(i) + "].specular", 1.0f*pointLightColor[i]);
        ...
        for (int i = 0; i < 4; i++) 
        {
            ...
            lightShader.setVec3("aColor", pointLightColor[i]);
